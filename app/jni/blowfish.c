 ...
 * Copyright (C) 2000 John Conneely except for portions taken from GnuPG.
 * 
 ...
 * 
 * This file was taken from GnuPG.  I've only modified it where necessary
 * to make it compile with the rest of FPM.  Changes made:
 * - Removed GPG specific include files
 *
...
selftest(void)
{
    ...
    bf_setkey( &c, (byte *)"abcdefghijklmnopqrstuvwxyz", 26 );
